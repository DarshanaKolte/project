...
// // Create a biquad filter node for each frequency band
// const bands = [
//     { frequency: 60, label: 'Jazz' },
//     { frequency: 170, label: 'Bass' },
...
// // Connect the source node to the destination through the filters
...
// bands.forEach(({ frequency, label }, index) => {
...
//     labelElement.htmlFor = `band-${frequency}`;
